/* @ts-self-types="./asagolf_kernel_wasm.d.ts" */

/**
 * Version/identity marker so the page can show which kernel it loaded.
 * @returns {string}
 */
export function kernel_id() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.kernel_id();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
 ...
 * @returns {string}
 */
export function lookup(src, label) {
    let deferred3_0;
    let deferred3_1;
    try {
        ...
        const ret = wasm.lookup(ptr0, len0, ptr1, len1);
        deferred3_0 = ret[0];
        deferred3_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 * @returns {string}
 */
export function parse_summary(src) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passStringToWasm0(src, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.parse_summary(ptr0, len0);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./asagolf_kernel_wasm_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('asagolf_kernel_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
