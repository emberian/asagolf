...
sdg-gauge-transport0 $p |- ( v + ( ( ( ap a x ) * v ) * 0 ) ) = v $= vv t0 tpl vv weq vv vx va tap vv tmu t0 tmu tpl vv weq vv ax-add0 vv vx va tap vv tmu t0 tmu tpl vv t0 tpl weq vv t0 tpl vv weq vv vx va tap vv tmu t0 tmu tpl vv weq wi vx va tap vv tmu t0 tmu t0 weq vv vx va tap vv tmu t0 tmu tpl vv t0 tpl weq vx va tap vv tmu ax-mul0 vx va tap vv tmu t0 tmu t0 vv eq-pl2 ax-mp vv vx va tap vv tmu t0 tmu tpl vv t0 tpl vv eqtri ax-mp ax-mp $.
sdg-gauge-kl-affine $p |- ( ( v + ( ( ( ap a x ) * v ) * 0 ) ) + ( ( ( ap a x ) * v ) * d ) ) = ( v + ( ( ( ap a x ) * v ) * d ) ) $= vv vx va tap vv tmu t0 tmu tpl vv weq vv vx va tap vv tmu t0 tmu tpl vx va tap vv tmu vd tmu tpl vv vx va tap vv tmu vd tmu tpl weq vv t0 tpl vv weq vv vx va tap vv tmu t0 tmu tpl vv weq vv ax-add0 vv vx va tap vv tmu t0 tmu tpl vv t0 tpl weq vv t0 tpl vv weq vv vx va tap vv tmu t0 tmu tpl vv weq wi vx va tap vv tmu t0 tmu t0 weq vv vx va tap vv tmu t0 tmu tpl vv t0 tpl weq vx va tap vv tmu ax-mul0 vx va tap vv tmu t0 tmu t0 vv eq-pl2 ax-mp vv vx va tap vv tmu t0 tmu tpl vv t0 tpl vv eqtri ax-mp ax-mp vv vx va tap vv tmu t0 tmu tpl vv vx va tap vv tmu vd tmu eq-pl1 ax-mp $.
${
  gauge.conj $e |- ( ap b x ) = ( ( ( ap g x ) * ( ap a x ) ) * ( ap w x ) ) $.
  sdg-gauge-conj-welldef $p |- ( ( ( ap b x ) * v ) * d ) = ( ( ( ( ( ap g x ) * ( ap a x ) ) * ( ap w x ) ) * v ) * d ) $= vx vb tap vv tmu vx vg tap vx va tap tmu vx vw tap tmu vv tmu weq vx vb tap vv tmu vd tmu vx vg tap vx va tap tmu vx vw tap tmu vv tmu vd tmu weq vx vb tap vx vg tap vx va tap tmu vx vw tap tmu weq vx vb tap vv tmu vx vg tap vx va tap tmu vx vw tap tmu vv tmu weq gauge.conj vx vb tap vx vg tap vx va tap tmu vx vw tap tmu vv eq-mu1 ax-mp vx vb tap vv tmu vx vg tap vx va tap tmu vx vw tap tmu vv tmu vd eq-mu1 ax-mp $.
$}
${
  gauge.law $e |- ( ap b x ) = ( ( ( ( ap g x ) * ( ap a x ) ) * ( ap w x ) ) + ( ap u x ) ) $.
  sdg-gauge-law-affine $p |- ( ( ( ap b x ) * v ) * d ) = ( ( ( ( ( ( ap g x ) * ( ap a x ) ) * ( ap w x ) ) + ( ap u x ) ) * v ) * d ) $= vx vb tap vv tmu vx vg tap vx va tap tmu vx vw tap tmu vx vu tap tpl vv tmu weq vx vb tap vv tmu vd tmu vx vg tap vx va tap tmu vx vw tap tmu vx vu tap tpl vv tmu vd tmu weq vx vb tap vx vg tap vx va tap tmu vx vw tap tmu vx vu tap tpl weq vx vb tap vv tmu vx vg tap vx va tap tmu vx vw tap tmu vx vu tap tpl vv tmu weq gauge.law vx vb tap vx vg tap vx va tap tmu vx vw tap tmu vx vu tap tpl vv eq-mu1 ax-mp vx vb tap vv tmu vx vg tap vx va tap tmu vx vw tap tmu vx vu tap tpl vv tmu vd eq-mu1 ax-mp $.
$}
sdg-gauge-F-cross $p |- ( ( ( ( ap a x ) * ( ap g x ) ) * v ) * ( d * e ) ) = ( ( ( ( ap g x ) * ( ap a x ) ) * v ) * ( d * e ) ) $= vx va tap vx vg tap tmu vv tmu vx vg tap vx va tap tmu vv tmu weq vx va tap vx vg tap tmu vv tmu vd ve tmu tmu vx vg tap vx va tap tmu vv tmu vd ve tmu tmu weq vx va tap vx vg tap tmu vx vg tap vx va tap tmu weq vx va tap vx vg tap tmu vv tmu vx vg tap vx va tap tmu vv tmu weq vx va tap vx vg tap ax-mulcom vx va tap vx vg tap tmu vx vg tap vx va tap tmu vv eq-mu1 ax-mp vx va tap vx vg tap tmu vv tmu vx vg tap vx va tap tmu vv tmu vd ve tmu eq-mu1 ax-mp $.
${
  gauge.fstr $e |- ( ap f ( d * e ) ) = ( ( ( ( ( ap a x ) * ( ap g x ) ) * v ) * ( d * e ) ) + ( ( ( ap c x ) * v ) * ( d * e ) ) ) $.
  sdg-gauge-covariant $p |- ( ap f ( d * e ) ) = ( ( ( ( ( ap g x ) * ( ap a x ) ) * v ) * ( d * e ) ) + ( ( ( ap c x ) * v ) * ( d * e ) ) ) $= vx va tap vx vg tap tmu vv tmu vd ve tmu tmu vx vc tap vv tmu vd ve tmu tmu tpl vx vg tap vx va tap tmu vv tmu vd ve tmu tmu vx vc tap vv tmu vd ve tmu tmu tpl weq vd ve tmu vf tap vx vg tap vx va tap tmu vv tmu vd ve tmu tmu vx vc tap vv tmu vd ve tmu tmu tpl weq vx va tap vx vg tap tmu vv tmu vd ve tmu tmu vx vg tap vx va tap tmu vv tmu vd ve tmu tmu weq vx va tap vx vg tap tmu vv tmu vd ve tmu tmu vx vc tap vv tmu vd ve tmu tmu tpl vx vg tap vx va tap tmu vv tmu vd ve tmu tmu vx vc tap vv tmu vd ve tmu tmu tpl weq vx va tap vx vg tap tmu vv tmu vx vg tap vx va tap tmu vv tmu weq vx va tap vx vg tap tmu vv tmu vd ve tmu tmu vx vg tap vx va tap tmu vv tmu vd ve tmu tmu weq vx va tap vx vg tap tmu vx vg tap vx va tap tmu weq vx va tap vx vg tap tmu vv tmu vx vg tap vx va tap tmu vv tmu weq vx va tap vx vg tap ax-mulcom vx va tap vx vg tap tmu vx vg tap vx va tap tmu vv eq-mu1 ax-mp vx va tap vx vg tap tmu vv tmu vx vg tap vx va tap tmu vv tmu vd ve tmu eq-mu1 ax-mp vx va tap vx vg tap tmu vv tmu vd ve tmu tmu vx vg tap vx va tap tmu vv tmu vd ve tmu tmu vx vc tap vv tmu vd ve tmu tmu eq-pl1 ax-mp vd ve tmu vf tap vx va tap vx vg tap tmu vv tmu vd ve tmu tmu vx vc tap vv tmu vd ve tmu tmu tpl weq vx va tap vx vg tap tmu vv tmu vd ve tmu tmu vx vc tap vv tmu vd ve tmu tmu tpl vx vg tap vx va tap tmu vv tmu vd ve tmu tmu vx vc tap vv tmu vd ve tmu tmu tpl weq vd ve tmu vf tap vx vg tap vx va tap tmu vv tmu vd ve tmu tmu vx vc tap vv tmu vd ve tmu tmu tpl weq wi gauge.fstr vd ve tmu vf tap vx va tap vx vg tap tmu vv tmu vd ve tmu tmu vx vc tap vv tmu vd ve tmu tmu tpl vx vg tap vx va tap tmu vv tmu vd ve tmu tmu vx vc tap vv tmu vd ve tmu tmu tpl eqtri ax-mp ax-mp $.
$}
